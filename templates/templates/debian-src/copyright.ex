This package was debianized by Nicolas Spalinger <nicolas.spalinger@sil.org>
on Tue, 31 Jan 2006. Thanks to Daniel Glassey <wdg@debian.org>.

See the Alioth project for co-maintainership of open fonts:
...
acknowledged as shown below on all unmodified copies of the 4 Charter Type 1
fonts.
...
This Font Software is Copyright (c) 1997-2007, SIL International (http://scripts.sil.org/).
All Rights Reserved.
